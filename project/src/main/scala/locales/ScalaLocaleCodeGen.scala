...
object CodeGenerator {
  ...
  def metadata(codes: List[String], languages: List[String], scripts: List[String], territoryCodes: Map[String, String]): Tree = {
    BLOCK (
...
object ScalaLocaleCodeGen {
  ...
  def generateMetadataFile(base: File, clazzes: List[XMLLDML], territoryCodes: Map[String, String]): File = {
