...
case class CurrencyDataFractionsInfo(
    currencyCode: String,
    digits: Int,
    rounding: Int,
...
case class CurrencyDataRegionCurrency(
    currencyCode: String,
    from: Option[String],
    to: Option[String],
...
//     fileName: String,
//     defaultNS: Option[NumericSystem],
